/**
 * Encapsulation of Random by Cryptico into a Nodejs Module, with minimum modifications
 *
 * Minimal modifications listed below:
 * - Using dependencies as Node Modules
 * - Exporting RSAKey as the module itself
 *
 * TODO: should use the Hashes from crypto-js
 * TODO: should support streaming hashing
 *
 * User: rafael
 * Date: 8/7/13
 * Time: 5:15 PM
...
var SecureRandom=require("../Random").SecureRandom,
    SeededRandom=SecureRandom,
    BigInteger=require("../BigInteger"),
    SHA1=require("./webkit/SHA1"),
    SHA256=require("./webkit/SHA256");
